...
export const follow = (id) => {
    return async (dispatch) => {
        followUnfollowFlow(dispatch, id, usersAPI.followed.bind(usersAPI), followSuccess);
    }
}

export const unfollow = (id) => {
    return async (dispatch) => {
        followUnfollowFlow(dispatch, id, usersAPI.unfollowed.bind(usersAPI), unfollowSuccess);
    }
}
